...
public final class EventManager {
     ...
     * a new MethodData to key's matching list and sorts it based on Priority. @see io.github.apricotfarmer11.mods.tubion.event.api.types.Priority
     ...
     *
     * @see io.github.apricotfarmer11.mods.tubion.event.api.EventTarget
     */
